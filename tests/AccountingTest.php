...
class AccountingTest extends TestCase
{
    ...
    {
        $this->givenBudgets([
            new \App\Budget('201903', 31.00),
            new \App\Budget('201904', 30.00),
            new \App\Budget('201905', 31.00),
        ]);
        $this->givenStart(2019, 3, 31);
        $this->givenEnd(2019, 5, 1);
        $this->budgetShouldBe(32.00);
    }

    public function test_cross_three_month_with_another_budget()
    {
        $this->givenBudgets([
            new \App\Budget('201903', 31.00),
            new \App\Budget('201904', 30.00),
            new \App\Budget('201905', 31.00),
            new \App\Budget('201906', 3100.00),
        ]);
        $this->givenStart(2019, 3, 31);
        $this->givenEnd(2019, 5, 1);
        $this->budgetShouldBe(32.00);
